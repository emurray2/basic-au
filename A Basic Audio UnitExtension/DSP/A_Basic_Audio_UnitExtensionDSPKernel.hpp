//
//  A_Basic_Audio_UnitExtensionDSPKernel.hpp
...
#import "A_Basic_Audio_UnitExtension-Swift.h"
#import "A_Basic_Audio_UnitExtensionParameterAddresses.h"

/*
 A_Basic_Audio_UnitExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class A_Basic_Audio_UnitExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in A_Basic_Audio_UnitExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case A_Basic_Audio_UnitExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<A_Basic_Audio_UnitExtensionDSPKernel *>(context);
