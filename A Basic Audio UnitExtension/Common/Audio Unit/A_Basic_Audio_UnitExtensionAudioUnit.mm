//
//  A_Basic_Audio_UnitExtensionAudioUnit.mm
...
#import "A_Basic_Audio_UnitExtensionAUProcessHelper.hpp"
#import "A_Basic_Audio_UnitExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface A_Basic_Audio_UnitExtensionAudioUnit ()
...
@implementation A_Basic_Audio_UnitExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    A_Basic_Audio_UnitExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block A_Basic_Audio_UnitExtensionDSPKernel *kernel = &_kernel;
