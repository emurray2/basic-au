//
//  A_Basic_Audio_UnitExtensionAUProcessHelper.hpp
...
#include <vector>
#include "A_Basic_Audio_UnitExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(A_Basic_Audio_UnitExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    A_Basic_Audio_UnitExtensionDSPKernel& mKernel;
